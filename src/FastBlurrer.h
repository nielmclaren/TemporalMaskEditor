...
#ifndef __KinectTemporalMaskEditor__FastBlurrer__
#define __KinectTemporalMaskEditor__FastBlurrer__
...
public:
  ...
  void init(int _width, int _height, int _radius) {
    if (initialized) {
      destroy();
    }
...
#endif /* defined(__KinectTemporalMaskEditor__FastBlurrer__) */
